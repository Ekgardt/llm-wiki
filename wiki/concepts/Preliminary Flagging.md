...
- Pages where the "inferred" content is actually a design decision made in this repo — record it as a decision in `memory/knowledge/decisions/`, not as a preliminary wiki claim.

## Source
- Origin: session memory — [[memory/knowledge/decisions/flag-inferred-content-as-preliminary]] (decision dated 2026-04-13).
...
## Related
- [[memory/knowledge/concepts/provenance-rule-6]] — the underlying CLAUDE.md rule this convention operationalizes.
- [[memory/knowledge/decisions/flag-inferred-content-as-preliminary]] — the dated decision that established this convention.
...
- [[Editorial Notes Pattern]] — sibling convention; the two partition the "no `Source:` line" space (editorial vs uncertain).
- [[Pipeline Mirroring]] — sibling convention surfaced by the same 2026-04-13 session.
