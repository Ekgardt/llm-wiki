...
[![Tests](https://img.shields.io/badge/tests-2513%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **2513 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (2513 тестов)
...
uv run pytest -q          # собирает 2513 тестов
```
