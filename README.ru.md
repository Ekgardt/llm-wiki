...
[![Tests](https://img.shields.io/badge/tests-2518%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **2518 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (2518 тестов)
...
uv run pytest -q          # собирает 2518 тестов
```
