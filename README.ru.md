...
[![Tests](https://img.shields.io/badge/tests-5063%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **5063 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (5063 тестов)
...
uv run pytest -q          # собирает 5063 тестов
```
