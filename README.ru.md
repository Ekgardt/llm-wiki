...
[![Tests](https://img.shields.io/badge/tests-1780%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **1780 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (1780 тестов)
...
uv run pytest -q          # собирает 1780 тестов
```
