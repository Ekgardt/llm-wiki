...
[![Tests](https://img.shields.io/badge/tests-812%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **812 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (812 тестов)
...
uv run pytest -q          # собирает 812 тестов
```
