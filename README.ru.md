...
- **419 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (419 тестов)
...
cd llm-wiki
uv sync
uv run pytest -q          # 419 тестов должны пройти
```
