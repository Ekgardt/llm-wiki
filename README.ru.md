...
[![Tests](https://img.shields.io/badge/tests-2519%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **2519 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (2519 тестов)
...
uv run pytest -q          # собирает 2519 тестов
```
