...
[![Tests](https://img.shields.io/badge/tests-4648%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **4648 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (4648 тестов)
...
uv run pytest -q          # собирает 4648 тестов
```
