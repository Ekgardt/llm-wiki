...
[![Tests](https://img.shields.io/badge/tests-5055%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **5055 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (5055 тестов)
...
uv run pytest -q          # собирает 5055 тестов
```
