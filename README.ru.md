...
[![Tests](https://img.shields.io/badge/tests-2514%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **2514 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (2514 тестов)
...
uv run pytest -q          # собирает 2514 тестов
```
