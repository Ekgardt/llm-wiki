...
- **353 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (353 тестов)
...
cd llm-wiki
uv sync
uv run pytest -q          # 353 тестов должны пройти
```
