...
[![Tests](https://img.shields.io/badge/tests-1662%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **1662 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (1662 тестов)
...
uv run pytest -q          # собирает 1662 тестов
```
