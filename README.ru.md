...
[![Tests](https://img.shields.io/badge/tests-2560%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **2560 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (2560 тестов)
...
uv run pytest -q          # собирает 2560 тестов
```
