...
[![Tests](https://img.shields.io/badge/tests-4938%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **4938 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (4938 тестов)
...
uv run pytest -q          # собирает 4938 тестов
```
