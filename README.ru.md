...
[![Tests](https://img.shields.io/badge/tests-4396%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **4396 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (4396 тестов)
...
uv run pytest -q          # собирает 4396 тестов
```
