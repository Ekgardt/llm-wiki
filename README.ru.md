...
[![Tests](https://img.shields.io/badge/tests-4920%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **4920 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (4920 тестов)
...
uv run pytest -q          # собирает 4920 тестов
```
