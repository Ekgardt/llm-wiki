...
[![Tests](https://img.shields.io/badge/tests-3080%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **3080 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (3080 тестов)
...
uv run pytest -q          # собирает 3080 тестов
```
