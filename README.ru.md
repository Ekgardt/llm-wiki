...
[![Tests](https://img.shields.io/badge/tests-4627%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **4627 регрессионных тестов**, CI green на Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Запускает тестовый набор (4627 тестов)
...
uv run pytest -q          # собирает 4627 тестов
```
