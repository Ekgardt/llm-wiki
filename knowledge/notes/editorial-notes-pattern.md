...
Pages currently carrying the note: [[index]] (wiki navigation map), [[log]] (wiki changelog), [[knowledge/index|Knowledge index]] (human front door), `knowledge/index.md` (memory navigation map), and `knowledge/log.md` (memory changelog). The latter two were extended to carry editorial notes on 2026-04-18.
