...
description: "The memory subsystem (`memory/state/`, `knowledge/daily/`, `knowledge/notes/`) resolves to a single canonical location regardless of whether Claude Code runs from the main checkout or a git worktree."
timestamp: 2026-07-03T05:41:37
---
# Centralized Memory Subsystem Independent Of Worktree Mode

One-sentence summary: The memory subsystem (`memory/state/`, `knowledge/daily/`, `knowledge/notes/`) resolves to a single canonical location regardless of whether Claude Code runs from the main checkout or a git worktree.
