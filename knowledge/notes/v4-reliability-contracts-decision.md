---
type: decision
title: "V4 Reliability Target Uses Versioned Input Identity And Durable Operational Ownership"
description: "The approved, not-yet-implemented V4 reliability target would add path-bound compile receipts, truthful queue serialization, durable capture intents, unified fenced ownership, and bounded execution while preserving Markdown authority and the 12-tool local runtime."
date: 2026-08-05
confidence: high
source_authority: user
status: active
---
# V4 Reliability Target Uses Versioned Input Identity And Durable Operational Ownership

One-sentence summary: The approved, not-yet-implemented V4 reliability target would add path-bound compile receipts, truthful queue serialization, durable capture intents, unified fenced ownership, and bounded execution while preserving Markdown authority and the 12-tool local runtime.

## Decision

Date: 2026-08-05.

This page records approved target architecture. It does not describe implemented
production behavior.
...
- Existing public source-install URLs remain published; promotion to an immutable
  release remains blocked until implementation and release evidence pass.
