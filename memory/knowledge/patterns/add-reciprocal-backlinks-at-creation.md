...
**Apply to:** any new page in `wiki/` or `memory/knowledge/` that uses a wikilink to an existing page.
...
## Evidence
- `memory/daily/2026-04-19.md` [03:00:46] — lesson recorded after new [[Global Multi-Project Migration Plan]] page was created with 4 backlinks but no reciprocals; all five target pages had to be updated in a follow-up pass.

## Related
- [[memory/knowledge/patterns/audit-current-vs-intended]] — complementary: once you have reciprocal backlinks, audits catch drift between intent and reality
- [[memory/knowledge/concepts/provenance-rule-6]] — underlying rule: make relationships explicit, not implicit
