...
## Evidence
- `memory/daily/2026-04-19.md` [17:09:56] — B-sim false `❌ Notes lost` incident; root cause identified as case mismatch
- `memory/daily/2026-04-19.md` [17:14:57] — confirmed same gotcha; "❌ Notes lost" while `'Where we left off' preserved` was passing on identical content

## Related
- [[memory/knowledge/patterns/b-sim-hook-testing]] — the testing pattern where this gotcha most commonly appears
- [[memory/knowledge/debugging/hook-errors-silent-without-state-root]] — sibling hook-testing debugging entry
