...
## Variants seen
- **Duplicated log entries.** Appending a dated entry to `wiki/log.md` or `memory/log.md` when a previous day already contained the exact same leading phrase.
...
## Evidence
- `memory/daily/2026-04-13.md` [00:57:04] — occurred while appending to `wiki/log.md` during the comparison-page session.

## Related
- [[Ingestion Workflow]]
- [[memory/knowledge/concepts/editorial-notes-pattern]] — the incident that surfaced this bug also surfaced that pattern.
