...
## Evidence
- `memory/daily/2026-04-19.md` [17:09:56] — Phase 4 soak test surfaced the silent-error bug
- `memory/daily/2026-04-19.md` [17:24:33] — fix (`_resolve_state_root`) confirmed and committed

## Related
- [[memory/knowledge/decisions/hook-scripts-defense-in-depth]] — broader defense-in-depth decision covering this fix + slug guard
- [[memory/knowledge/patterns/b-sim-hook-testing]] — technique for exercising hook scripts manually
