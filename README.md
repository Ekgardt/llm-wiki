...
[![Tests](https://img.shields.io/badge/tests-374%20passing-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **374 regression tests**, CI green on Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Runs the test suite (374 tests collected)
...
cd llm-wiki
uv sync
uv run pytest -q          # 374 tests collected should pass
```
