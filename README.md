...
[![Tests](https://img.shields.io/badge/tests-1801%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **1801 regression tests**, CI green on Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Runs the test suite (1801 tests collected)
...
uv run pytest -q          # collects 1801 tests
```
