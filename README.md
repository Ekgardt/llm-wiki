...
[![Tests](https://img.shields.io/badge/tests-4823%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **4823 regression tests**, CI green on Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Runs the test suite (4823 tests collected)
...
uv run pytest -q          # collects 4823 tests
```
