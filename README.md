...
[![Tests](https://img.shields.io/badge/tests-4653%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **4653 regression tests**, CI green on Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Runs the test suite (4653 tests collected)
...
uv run pytest -q          # collects 4653 tests
```
