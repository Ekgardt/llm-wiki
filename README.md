...
[![Tests](https://img.shields.io/badge/tests-326%20passing-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **326 regression tests**, CI green on Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Runs the test suite (326 tests collected)
...
cd llm-wiki
uv sync
uv run pytest -q          # 326 tests collected should pass
```
