...
[![Tests](https://img.shields.io/badge/tests-407%20passing-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **407 regression tests**, CI green on Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Runs the test suite (407 tests collected)
...
cd llm-wiki
uv sync
uv run pytest -q          # 407 tests collected should pass
```
