...
[![Tests](https://img.shields.io/badge/tests-4802%20collected-brightgreen.svg)](https://github.com/Ekgardt/llm-wiki/actions)
...
- **4802 regression tests**, CI green on Ubuntu + Windows + macOS, Python 3.10 + 3.13
...
4. Runs the test suite (4802 tests collected)
...
uv run pytest -q          # collects 4802 tests
```
