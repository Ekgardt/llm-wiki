...
> **История, а не текущее состояние (помечено 2026-09-24).** Документ описывает
> систему на дату своего среза; ветки, метки и файлы, которые он называет, могли
> исчезнуть. Текущее состояние — `docs/AUDIT-2026-09-24-live.md`.
