...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 3080 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 3080 tests collected
- If `< 3080`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 3080 tests collected |
