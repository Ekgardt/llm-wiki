...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4470 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4470 tests collected
- If `< 4470`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4470 tests collected |
