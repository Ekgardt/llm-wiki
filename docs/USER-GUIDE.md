...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 5035 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 5035 tests collected
- If `< 5035`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 5035 tests collected |
