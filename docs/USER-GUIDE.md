...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4697 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4697 tests collected
- If `< 4697`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4697 tests collected |
