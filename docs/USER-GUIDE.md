...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4466 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4466 tests collected
- If `< 4466`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4466 tests collected |
