...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 5063 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 5063 tests collected
- If `< 5063`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 5063 tests collected |
