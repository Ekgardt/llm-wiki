...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4823 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4823 tests collected
- If `< 4823`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4823 tests collected |
