...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4484 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4484 tests collected
- If `< 4484`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4484 tests collected |
