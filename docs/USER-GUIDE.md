...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 2560 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 2560 tests collected
- If `< 2560`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 2560 tests collected |
