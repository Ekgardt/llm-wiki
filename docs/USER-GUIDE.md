...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4819 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4819 tests collected
- If `< 4819`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4819 tests collected |
