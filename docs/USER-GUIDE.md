...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4688 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4688 tests collected
- If `< 4688`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4688 tests collected |
