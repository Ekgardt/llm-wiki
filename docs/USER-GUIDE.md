...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 2513 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 2513 tests collected
- If `< 2513`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 2513 tests collected |
