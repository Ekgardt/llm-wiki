...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4453 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4453 tests collected
- If `< 4453`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4453 tests collected |
