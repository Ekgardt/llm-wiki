...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4802 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4802 tests collected
- If `< 4802`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4802 tests collected |
