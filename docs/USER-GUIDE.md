...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4933 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4933 tests collected
- If `< 4933`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4933 tests collected |
