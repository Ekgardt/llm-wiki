...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4489 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4489 tests collected
- If `< 4489`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4489 tests collected |
