...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4806 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4806 tests collected
- If `< 4806`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4806 tests collected |
