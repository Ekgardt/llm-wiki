...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4419 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4419 tests collected
- If `< 4419`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4419 tests collected |
