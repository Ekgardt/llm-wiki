...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4700 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4700 tests collected
- If `< 4700`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4700 tests collected |
