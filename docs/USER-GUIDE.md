...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4976 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4976 tests collected
- If `< 4976`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4976 tests collected |
