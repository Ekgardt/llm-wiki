...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4693 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4693 tests collected
- If `< 4693`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4693 tests collected |
