...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4412 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4412 tests collected
- If `< 4412`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4412 tests collected |
