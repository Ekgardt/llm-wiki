...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4970 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4970 tests collected
- If `< 4970`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4970 tests collected |
