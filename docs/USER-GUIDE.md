...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4918 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4918 tests collected
- If `< 4918`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4918 tests collected |
