...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4457 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4457 tests collected
- If `< 4457`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4457 tests collected |
