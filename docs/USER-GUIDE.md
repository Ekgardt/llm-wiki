...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4764 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4764 tests collected
- If `< 4764`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4764 tests collected |
