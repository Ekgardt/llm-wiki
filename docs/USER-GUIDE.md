...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4686 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4686 tests collected
- If `< 4686`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4686 tests collected |
