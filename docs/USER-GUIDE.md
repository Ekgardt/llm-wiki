...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4980 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4980 tests collected
- If `< 4980`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4980 tests collected |
