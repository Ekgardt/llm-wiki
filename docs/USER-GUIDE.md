...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4828 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4828 tests collected
- If `< 4828`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4828 tests collected |
