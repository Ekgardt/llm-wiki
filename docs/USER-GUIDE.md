...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 5055 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 5055 tests collected
- If `< 5055`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 5055 tests collected |
