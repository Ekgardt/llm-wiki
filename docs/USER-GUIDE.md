...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 3081 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 3081 tests collected
- If `< 3081`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 3081 tests collected |
