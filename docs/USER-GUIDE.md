...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 3609 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 3609 tests collected
- If `< 3609`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 3609 tests collected |
