...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 5049 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 5049 tests collected
- If `< 5049`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 5049 tests collected |
