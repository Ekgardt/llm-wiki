...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 2514 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 2514 tests collected
- If `< 2514`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 2514 tests collected |
