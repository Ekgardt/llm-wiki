...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 2518 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 2518 tests collected
- If `< 2518`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 2518 tests collected |
