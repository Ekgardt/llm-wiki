...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4396 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4396 tests collected
- If `< 4396`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4396 tests collected |
