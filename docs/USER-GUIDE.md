...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4401 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4401 tests collected
- If `< 4401`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4401 tests collected |
