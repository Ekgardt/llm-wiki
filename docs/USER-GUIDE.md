...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4792 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4792 tests collected
- If `< 4792`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4792 tests collected |
