...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4920 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4920 tests collected
- If `< 4920`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4920 tests collected |
