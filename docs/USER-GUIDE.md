...
1. **Clone + install dependencies:**
   ...
   uv run pytest -q          # verify: 4440 tests collected should pass
   ```
...
- `uv run pytest -q` — should report 4440 tests collected
- If `< 4440`, your checkout is stale; `git pull`
...
| `tests/` | CODE | 4440 tests collected |
