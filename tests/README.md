...
The suite currently has **353 tests across 29 files**. Highlights:
...
| `test_readme_i18n.py` | All 3 READMEs exist, share live count (353), correct repo (`Ekgardt/llm-wiki`), mention `knowledge/`, mention `3.4.0`. |
...
No pre-configuration required. Output: 353 passed in ~3s.
