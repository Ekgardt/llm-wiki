...
The suite currently has **399 tests across 33 files**. Highlights:
...
| `test_readme_i18n.py` | All 3 READMEs exist, share live count (399), correct repo (`Ekgardt/llm-wiki`), mention `knowledge/`, mention `3.4.0`. |
...
No pre-configuration required. Output: 399 passed in ~3s.
