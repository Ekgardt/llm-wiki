...
The suite currently has **390 tests across 30 files**. Highlights:
...
| `test_readme_i18n.py` | All 3 READMEs exist, share live count (390), correct repo (`Ekgardt/llm-wiki`), mention `knowledge/`, mention `3.4.0`. |
...
No pre-configuration required. Output: 390 passed in ~3s.
