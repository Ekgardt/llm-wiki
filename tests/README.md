...
The suite currently has **366 tests across 30 files**. Highlights:
...
| `test_readme_i18n.py` | All 3 READMEs exist, share live count (366), correct repo (`Ekgardt/llm-wiki`), mention `knowledge/`, mention `3.4.0`. |
...
No pre-configuration required. Output: 366 passed in ~3s.
