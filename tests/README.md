...
| `test_readme_i18n.py` | All 3 READMEs exist, share live count (419), correct repo (`Ekgardt/llm-wiki`), mention `knowledge/`, mention `3.4.0`. |
...
No pre-configuration required. Output: 419 passed in ~3s.
